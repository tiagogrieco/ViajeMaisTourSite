            ...
            foreach ( $settings[ 'hot_spots' ] as $index => $item ) {
                ...
                if ( !empty( $item[ 'tooltip' ] ) ) {
                    $options = [
                        ...
                        'tooltipContent'   => wp_kses_post( stratum_decode_html_entities( $item[ 'tooltip_content' ] ) ),
                        'tooltipTitle'     => wp_kses_post( stratum_decode_html_entities( $item[ 'tooltip_title' ] ) )
                    ];
